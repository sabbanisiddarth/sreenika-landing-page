...
var isSupportWebGPU = () => {
  return !!navigator.gpu && isSupportJSPI();
};
...
var LIBLLAMA_VERSION = "b9108-928b486";
...
var ProxyToWorker = class {
  constructor(pathConfig, nbThread, suppressNativeLog, logger) {
    ...
    return __async(this, arguments, function* (url, options = {}) {
      ...
      return yield new Promise((resolve, reject) => {
        ...
        worker.postMessage({
          ...
          filename,
          metadataFileName,
          metadataAdditional: (_a = options.metadataAdditional) != null ? _a : {},
        ...
        worker.onmessage = (e) => {
          ...
          if (e.data.ok) {
            ...
            (_a2 = options.progressCallback) == null ? void 0 : _a2.call(options, progress);
          } else {
...
var Wllama = class {
  ...
  createEmbedding(options) {
    return __async(this, null, function* () {
      ...
      return yield this.getRespose(options, false);
    });
  }
  createChatCompletion(options) {
    return __async(this, null, function* () {
      return options.stream ? yield this.createCompletionGenerator(options) : yield this.createCompletionImpl(__spreadProps(__spreadValues({}, options), { stream: false }));
    });
  }
  ...
  createCompletionImpl(options) {
    return __async(this, null, function* () {
      ...
      return yield this.getRespose(options, isStream);
    });
  }
  /**
      ...
      const createGenerator = cbToAsyncIter(
        (callback) => {
          this.createCompletionImpl(__spreadProps(__spreadValues({}, options), {
            onData: (chunk) => {
              callback(chunk);
              origOnData == null ? void 0 : origOnData(chunk);
            }
          })).catch(reject).then(() => {
